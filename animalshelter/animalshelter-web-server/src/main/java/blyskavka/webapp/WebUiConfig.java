...
public class WebUiConfig extends AbstractWebUiConfig {
    ...
    public WebUiConfig(final String domainName, final int port, final Workflows workflow, final String path) {
        super("animalshelter", workflow, new String[] { "blyskavka/" });
    ...
    public void initConfiguration() {
        ...
        .addModule(Modules.USERS_AND_PERSONNEL.title)
            ...
            .menu()
                ...
                .done()
            .done().done()
        .addModule(Modules.ANIMALS.title)
            .description(Modules.ANIMALS.desc)
            .icon(Modules.ANIMALS.icon)
            .detailIcon(Modules.ANIMALS.icon)
            .bgColor(Modules.ANIMALS.bgColour)
            .captionBgColor(Modules.ANIMALS.captionBgColour)
            .menu()
